        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IntervalTimer = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimeLogs_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_Name_Building_Floor",
                table: "Rooms",
                columns: new[] { "Name", "Building", "Floor" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TimeLogs_RoomId",
                table: "TimeLogs",
                column: "RoomId");
        }
